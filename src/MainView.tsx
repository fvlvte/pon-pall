...
import { View, StyleSheet, ImageBackground, Dimensions, Animated, Text, SafeAreaView } from "react-native";
...
export const MainView: () => React.JSX.Element = () => {
    ...
    const [currentMenuBackground, setCurrentMenuBackground] = React.useState(require("../assets/menu-bg.png"));
    ...
    return <View style={Styles.viewContainer}>
                    <ImageBackground 
                        ...
                        <Animated.View style={{opacity: fadeInAnimMenu}}>
                            <TopMenu gameState={0} setGameState={() => {}} ></TopMenu>
                        </Animated.View>
